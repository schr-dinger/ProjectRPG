...
void AC_TopDownCharacter::SerRPCAttack_Implementation(UAnimMontage* AttackMon)
{
	MulRPCAttack(AttackMon);
}

void AC_TopDownCharacter::MulRPCAttack_Implementation(UAnimMontage* AttackMon)
{
