...
void AC_TopDownCharacter::SerRPCWAttack_Implementation(UAnimMontage* AttackMon)
{
	...
	SkillManager->SerSpawnAttack(this, WSkill, mouselocation, W->isFloor, W->isMove);
...
void AC_TopDownCharacter::SerRPCEAttack_Implementation(UAnimMontage* AttackMon)
{
	isQSkill = false;
	isWSkill = false;
	...
	SkillManager->SerSpawnAttack(this, ESkill, mouselocation, E->isFloor, E->isMove);
